...
import { CookieEnum } from '@client_public/models/cookie'
import { getCookie, storageGet, storageRemove } from '@client_shared/utils'
...
const createApolloClient = (userLanguage: string) => new ApolloClient({
    ...
    link: new HttpLink({
      uri: `http://${process.env.APP_HOST}:${process.env.APP_PORT}/graphql`,
